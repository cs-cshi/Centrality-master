...
#
# hash_master_seed = 0x22221111
# salt0 = calc_combined_hash_salt32(hash_master_seed, 3)
# hash_fun = HashEx32(salt0)
# hash_value = hash_fun.hash(bytes(1112))
# print(hash_value % 255)
