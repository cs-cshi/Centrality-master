...
def get_jaccard_similarity(this, that):
    intersection_set = [i for i in this if i in that]
    union_set = set(this + that)
    # print(this)
    # print(that)
    # intersection_set = this & that
    # union_set = this | that
    print('len(inter_set) = ' + str(len(intersection_set)))
    print('len(union_set) = ' + str(len(union_set)))
